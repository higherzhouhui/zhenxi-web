      ...
      <div class="content">
        <section>
          ...
          <div class="cooperation">
            <div class="title">
              <img
                src="@/static/image/icon-cooperation.png"
                alt=""
                class="icon-cooperation"
              />
              <span>商务合作</span>
            </div>
            <ul>
        ...
        <aside>
          <div class="qrcode">
            ...
            <div class="name">IOS版</div>
          </div>
          <div class="qrcode">
            <div class="pic"></div>
            <div class="name">安卓版</div>
          </div>
        </aside>
      </div>
      <div class="copyright">
        Copyright © 2019 - 2020 版权所有©武汉振翕科技有限公司 |
        鄂ICP备19001039号-1
      </div>
    </div>
  </div>
...
.footer-body {
  background: url(@/static/image/footer.png);
