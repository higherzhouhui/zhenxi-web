  ...
  <div class="header-body">
    <div class="header">
      <div class="leftContainer">
        <nuxt-link to="/"
          ><svg-icon icon-class="head-logo" class="logo"
        /></nuxt-link>
        <div class="list">
          <nuxt-link to="/">
          ...
          <nuxt-link to="/getprice/">
            <div class="box" :class="{ active: currentPage == 3 }">
              <div class="menuTitle">服务选择</div>
            </div>
          </nuxt-link>
          <div class="box" :class="{ active: currentPage == 4 }">
            ...
            <div class="dropDown">
              ...
              <nuxt-link to="/aboutus/together/">
                <li style="border-bottom: none">渠道合作</li>
              </nuxt-link>
            </div>
          </div>
        </div>
      ...
      <div class="btnGroup">
        <nuxt-link to="/download/"
          ><Button class="down">下载企金控</Button></nuxt-link
        >
        <nuxt-link to="/aboutus/formapply"
          ><Button class="free">免费试用</Button></nuxt-link
        >
      </div>
      <div class="menuIconWraper" @click="handleMenuClick(!showMenu)">
        <svg-icon
          icon-class="head-menu"
          :class="showMenu ? 'menuIcon active' : 'menuIcon'"
        />
      </div>
      <Menu
        :left="showMenu ? '0' : '100vw'"
        :callBack="() => handleMenuClick(false)"
        :menus="menus"
      />
    </div>
  </div>
