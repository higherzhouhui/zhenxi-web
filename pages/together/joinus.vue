        ...
        <div class="left">
          ...
          <div class="downLoad">
            <div class="erweima">
              ...
              <!-- <img src="@/static/image/ios-down.png" v-if="currentTab == 'ios'"/> -->
              <!-- <img src="@/static/image/android-down.png" v-if="currentTab == 'android'"/> -->
            </div>
            <div class="tabs">
              <img src="@/static/image/together/ios.png" v-on:click="handleClickDownIcon('ios')" alt="">
              <img src="@/static/image/together/android.png" v-on:click="handleClickDownIcon('android')" alt="">
            </div>
          </div>
        </div>
          ...
          <div class="inputContainer">
            ...
            <div class="yzm-popup" :style="{width: width + 'px',visibility: popUpImg ? 'visible' : 'hidden'}">
              ...
              <div class="slideBtnWrapper" :style="{width: width + 'px'}">
                ...
                <div class="slideRight" v-show="!left">向右滑动-></div>
              </div>
            </div>
